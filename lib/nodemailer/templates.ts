            ...
            <div class="content">
                <div class="summary">
                    ...
                    <ul style="margin: 10px 0; padding-left: 20px;">
                        ${bullishPatterns.length > 0 ? `<li><strong>${bullishPatterns.length}</strong> Bullish signals 📈</li>` : ''}
                        ${bearishPatterns.length > 0 ? `<li><strong>${bearishPatterns.length}</strong> Bearish signals 📉</li>` : ''}
                    </ul>
                    ${isRealtime ? '<p><strong>⚡ Real-time Alert:</strong> These patterns were detected during active market hours.</p>' : ''}
                </div>

                ${bullishPatterns.length > 0 ? `
                <div class="pattern-section">
                    <h3 class="bullish-header">🚀 Bullish Patterns</h3>
                ...
                <div class="pattern-section">
                    <h3 class="bearish-header">📉 Bearish Patterns</h3>
                ...
                <div style="background: #fff7ed; border: 1px solid #fb923c; border-radius: 6px; padding: 15px; margin-top: 20px;">
                    <h4 style="color: #c2410c; margin: 0 0 10px 0;">⚠️ Important Disclaimer</h4>
...
export const sendPatternAlert = async (data: PatternAlertData) => {
  const subject = `${data.isRealtime ? '⚡ Real-time' : '📊 Daily'} Pattern Alert - ${data.bullishPatterns.length + data.bearishPatterns.length} Patterns Detected`;
